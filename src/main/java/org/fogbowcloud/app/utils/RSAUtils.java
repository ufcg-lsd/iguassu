...
public class RSAUtils {
    ...
    public static RSAPrivateKey getPrivateKeyFromString(String key)
        ...
        RSAPrivateKey privKey =
                (RSAPrivateKey) kf.generatePrivate(new PKCS8EncodedKeySpec(encoded));
        return privKey;
    }
    ...
    public static boolean verify(PublicKey publicKey, String message, String signature)
            throws SignatureException, NoSuchAlgorithmException, UnsupportedEncodingException,
                    InvalidKeyException {
        Signature sign = Signature.getInstance("SHA1withRSA");
    ...
    public static String encrypt(String rawText, PublicKey publicKey)
        ...
        return new String(
                org.bouncycastle.util.encoders.Base64.encode(
                        cipher.doFinal(rawText.getBytes(StandardCharsets.UTF_8))));
    }
    ...
    public static String decrypt(String cipherText, PrivateKey privateKey)
        ...
        return new String(
                cipher.doFinal(org.bouncycastle.util.encoders.Base64.decode(cipherText)), StandardCharsets.UTF_8);
    }
    ...
    public static String encryptAES(byte[] keyData, String data) throws Exception {
        ...
        byte[] encryptBytes = aes.doFinal(data.getBytes(StandardCharsets.UTF_8));
    ...
    public static String decryptAES(byte[] keyData, String data) throws Exception {
        ...
        byte[] decryptedBytes =
                cipher.doFinal(
                        org.bouncycastle.util.encoders.Base64.decode(data.getBytes(StandardCharsets.UTF_8)));
