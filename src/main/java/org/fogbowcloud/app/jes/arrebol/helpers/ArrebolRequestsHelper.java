...
public final class ArrebolRequestsHelper {
     ...
     */
    public String submitToExecution(String queueId, Job job)
        ...
        final String endpoint = String.format(Endpoint.JOBS, serviceBaseUrl, queueId);
     ...
     * @throws ArrebolConnectException if the Arrebol Job Execution Service is down.
     */
    public JobExecArrebol getExecutionStatus(String queueId, String executionId)
