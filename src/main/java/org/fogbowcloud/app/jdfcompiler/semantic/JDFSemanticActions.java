...
public class JDFSemanticActions implements SemanticActions {
    ...
    /**
     * @see
     *     org.ourgrid.common.specification.semantic.SemanticActions#performAction(java.lang.String,
    ...
    /**
     * This action: Sets the actual script of the remote script. Actual can be jobs (default) script
    ...
    /**
     * This action: Initializes the "condition" string for the actual block of I/O commands or job
     * expression.
     */
    ...
    /**
     * This action: Sets the condition string to null, it means that the condition read will not be
     * used anymore.
     */
    ...
    /**
     * This action: Will push a empty String object at the stack. It happens when the I/O entries
    ...
    /**
     * This action: Will push the other parts ( command, file, path ) of the I/O commands at the
     * stack.
     */
    ...
    public void action22() throws SemanticException {
        ...
        try {
            ...
            throw new SemanticException(
                    "Tried to contruct a Job Spec based on a problematic list of Tasks Specs. ");
        }
    ...
    /**
     * This action: initializes the object JobSpec with a empty string because any label was
     * defined.
     */
    ...
    public void action31() throws SemanticException {
        ...
        if (tempAttValue.equals("")) {
            throw new SemanticException(
                    CompilerMessages.SEMANTIC_EMPTY_ATTRIBUTE_VALUE(
                            stack.pop(), actualToken.getLine()));
        }
        this.stack.push(tempAttValue);
    }

    /**
     * This action: Inserts a new attribute at the actual worker specification or at the default map
    ...
    /**
     * This action: Advances the counter so we can know which block group(init, task or final) to
    ...
    private void checkTaskEntries() {
        ...
        if (inputEntries == null) {
            if (jobInputEntries != null) inputEntries = jobInputEntries;
            else inputEntries = new IOCommand();
        }
        ...
        if (outputEntries == null) {
            if (jobOutputEntries != null) outputEntries = jobOutputEntries;
            else outputEntries = new IOCommand();
        }
    }
     ...
     */
    private IOEntry buildEntry(String command, String filePath, String place)
            throws SemanticException {
