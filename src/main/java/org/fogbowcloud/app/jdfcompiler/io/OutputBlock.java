 ...
 *
 */
package org.fogbowcloud.app.jdfcompiler.io;
...
public class OutputBlock extends IOCommand {
     ...
     */
    public OutputBlock(
            List<String> outputSandBox,
            String outputSandBoxBaseURI,
            List<String> outputSandBoxDest) {
        super();
    ...
    private void buildEntries() {
        ...
        for (int i = 0; i < outputSandBox.size(); i++) {
            putEntry(
                    "",
                    new IOEntry(
                            "GET", outputSandBox.get(i), path.concat(outputSandBoxDest.get(i))));
        }
    }
